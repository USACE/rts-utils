...
class Extract():
    ...
    class Extract_Runnable(java.lang.Runnable):
        """_summary_"""
        ...
        def run(self):
            ...
            frame.setTitle("Extract Time Series Configuration")
            ...
            layout.setVerticalGroup(
                layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(
                    ...
                    .addPreferredGap(
                        LayoutStyle.ComponentPlacement.RELATED, 17, java.lang.Short.MAX_VALUE
                    )
                    .addGroup(
                        layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                        .addComponent(execute_button)
